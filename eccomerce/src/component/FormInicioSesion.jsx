...
import "../styles/FormInicioStyle.css"

const FormInicioSesion = ({ onSignUpClick }) => {
  return (
    ...
    <div class="form-container">
      ...
      <form class="form">
        ...
        <p class="page-link">
          <span class="page-link-label">Olvidó su contraseña?</span>
        </p>
        <button class="form-btn">Iniciar</button>
      </form>
      <p class="sign-up-label">
        ¿Todavía no tiene una cuenta?<span className="sign-up-link" onClick={onSignUpClick}> Regístrese
        </span>
      </p>
      <div class="buttons-container">
        <div class="apple-login-button">
          ...
          <span>Inicie sesión con Apple</span>
        </div>
